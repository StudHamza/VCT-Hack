...
table_details = {
    "game_changers_2024_gamedata": "Game data for Valorant Game Changers 2024, includes player performance metrics such as average_drp, damage_std_dev, damage_dealt, damage_taken, players_killed, assists, and head_shots. Use this as the default table if none specified."
}
...
def create_sql_engine():
    ...
    database = Connections.VALORANT_ESPORTS_DATABASE

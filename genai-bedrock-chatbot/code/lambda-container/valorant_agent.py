...
def valorant_data_tool(reasoning_query):
    """
    Tool for querying Valorant Esports data
    """
...
def agent_call(llm, query):
    ...
    """
    rag_tool = Tool(
    name="Valorant Pages and Guides",
    func=doc_tool,
    description="Useful for querying the Valorant knowledge base for information on agents, maps, game mechanics, and team strategies. Input should be a question formatted as a string.",
    )
    data_tool = Tool(
        name="Valorant Esports Data Retrieval",
        func=valorant_data_tool,
        description="Useful for querying the Valorant Esports database for detailed player statistics, team data, and performance metrics.Input should be a question formatted as a string.",
    )
